...
<head>
  ...
  <!-- progress barstle -->
  <link rel="stylesheet" href="{{asset('frontend/asset')}}/css/css-circular-prog-bar.css">
  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,700&display=swap" rel="stylesheet">
  <!-- font wesome stylesheet -->
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/{{asset('frontend/asset')}}/css/font-awesome.min.css">
...
<body>
        ...
        <div class="hero_detail-box">
          ...
          <div class="hero_btn-continer">
            <a href="" class="call_to-btn btn_white-border">
              ...
              <img src="{{asset('frontend/asset')}}/images/right-arrow.png" alt="">
            </a>
          </div>
        </div>
        <div class="hero_img-container">
          <div>
            <img src="{{asset('frontend/asset')}}/images/hero.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="about_img-box ">
        <img src="{{asset('frontend/asset')}}/images/kids.jpg" alt="" class="img-fluid w-100">
      </div>
  ...
  <section class="teacher_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="teacher_container layout_padding2">
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="{{asset('frontend/asset')}}/images/teacher-1.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Den Mark</h5>
            </div>
          </div>
          <div class="card">
            <img class="card-img-top" src="{{asset('frontend/asset')}}/images/teacher-2.jpg" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="{{asset('frontend/asset')}}/images/teacher-3.jpg" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="{{asset('frontend/asset')}}/images/teacher-4.jpg" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="vehicle_img-box ">
                <img src="{{asset('frontend/asset')}}/images/bus.png" alt="" class="img-fluid w-100">
              </div>
            </div>
        ...
        <div class="client_container d-flex flex-column">
          <div class="client_detail d-flex align-items-center">
            <div class="client_img-box ">
              <img src="{{asset('frontend/asset')}}/images/student.png" alt="">
            </div>
        ...
        <div class="container">
          <div class="admission_container position-absolute">
            <div class="admission_img-box">
              <img src="{{asset('frontend/asset')}}/images/kidss.jpg" alt="">
            </div>
  ...
  <script type="text/javascript" src="{{asset('frontend/asset')}}/js/jquery-3.4.1.min.js"></script>
  <script type="text/javascript" src="{{asset('frontend/asset')}}/js/bootstrap.js"></script>
